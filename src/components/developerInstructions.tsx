const DeveloperInstructions = ({
  ...
  return (
    <section className={`${mt ? "mt-" + mt : "mt-16"}`}>
      ...
      <div className="prose-base dark:prose-invert leading-relaxed text-white dark:text-black bg-sidebar p-3 sm:p-6 rounded-lg border-primary border-l-4 shadow-xl shadow-gray-300 dark:shadow-gray-700 text-sm sm:text-base w-full">
