...
export function UserProfileForm({ user }: UserProfileFormProps) {
    ...
    const [avatar, setAvatar] = useState(user.avatar || 'https://i.pravatar.cc/150?u=a042581f4e29026704d');
                ...
                <CardContent className="space-y-8 px-2">
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex-grow">
                            ...
                            <p className="text-xs text-muted-foreground mt-2">Recommended: 400x400px. Max file size: 1MB.</p>
                        </div>
                    </div>
