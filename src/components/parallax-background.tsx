...
export function ParallaxBackground() {
  ...
  const glowX = useSpring(mousePosition.x * 15, springConfig);
  const glowY = useSpring(mousePosition.y * 15, springConfig);
  ...
  return (
    <div className="relative w-[400px] h-[200px] flex items-center justify-center">
        ...
        {/* Glow */}
        <motion.div
            className="absolute z-5 w-64 h-64 bg-gradient-radial from-primary/30 to-transparent rounded-full blur-3xl"
