...
export const BackgroundBeams = React.memo(
  ({ className }: { className?: string }) => {
    ...
    return (
      <div
        className={cn(
          "absolute inset-0 z-0 flex h-full w-full items-center justify-center bg-background [mask-repeat:no-repeat]",
          className
        )}
      >
        <svg
        ...
        >
          ...
          <defs>
            ...
            >
              <stop offset="0.0666667" stopColor="hsl(var(--primary))"></stop>
              <stop offset="0.243243" stopColor="hsl(var(--primary))"></stop>
