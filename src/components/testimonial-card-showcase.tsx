        ...
        <Card className="flex flex-col justify-between bg-card rounded-xl w-full h-full">
          <CardHeader>
            <div className="flex items-center gap-4">
              <Avatar>
                <AvatarImage
                  src={sampleTestimonial.avatar}
                  data-ai-hint={sampleTestimonial.dataAiHint}
                />
                <AvatarFallback>
                  {sampleTestimonial.name.charAt(0)}
                </AvatarFallback>
              </Avatar>
              <div>
          ...
          <CardContent>
            <p className="text-muted-foreground">
              &ldquo;{sampleTestimonial.comment}&rdquo;
            </p>
          </CardContent>
