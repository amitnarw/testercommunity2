...
export function SignupForm() {
  ...
  const handleGoogleSignup = () => {
    ...
    document.cookie =
      "isAuthenticated=true; path=/; max-age=" + 60 * 60 * 24 * 7;
    document.cookie = `user_name=Demo User; path=/; max-age=${
      60 * 60 * 24 * 7
    }`;
    document.cookie = `user_email=demo.user@gmail.com; path=/; max-age=${
      60 * 60 * 24 * 7
    }`;
    document.cookie = `user_avatar=https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=400&auto=format=fit=crop; path=/; max-age=${
      60 * 60 * 24 * 7
    }`;
    router.push("/dashboard");
  };
  ...
  return (
    <div data-loc="SignupForm" className="space-y-6">
      <Button
        variant="outline"
