...
export function RoadmapStepCard({ step, isPro }: RoadmapStepCardProps) {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "w-full h-full p-8 md:p-12 lg:p-24 flex items-center justify-center overflow-hidden",
        isPro 
    ...
    >
        ...
        <div className="max-w-7xl mx-auto w-full grid md:grid-cols-12 gap-8 md:gap-16 items-center relative z-10">
            ...
            <motion.div 
                ...
                className="md:col-span-4 lg:col-span-3 flex items-center justify-center"
            >
                <span className={cn(
                    "text-[12rem] lg:text-[15rem] font-black leading-none",
                    isPro 
            ...
            <motion.div 
                variants={cardVariants} // This will stagger its own children
                className="md:col-span-8 lg:col-span-9"
            >
                {badgeText && 
                    <motion.div variants={itemVariants}>
                        <Badge variant={isPro ? "default" : "secondary"} className="text-base py-2 px-4 rounded-lg mb-6 shadow-md">
                            {badgeText}
                        </Badge>
                    </motion.div>
                }
                ...
                <motion.div 
                    variants={itemVariants}
                    className="grid sm:grid-cols-2 gap-x-8 gap-y-6 border-l-2 border-primary/20 pl-6"
                >
