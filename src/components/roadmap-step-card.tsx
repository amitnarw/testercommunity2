    ...
    >
      <div
        className={cn(
          ...
          !isPro &&
            "bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-primary/5 via-transparent to-transparent dark:from-primary/10",
          isPro &&
            "bg-gradient-to-tr from-amber-400/10 via-transparent to-transparent dark:from-amber-400/20"
        )}
      ></div>
          ...
          {badgeText && (
            <motion.div variants={itemVariants}>
              <Badge
                ...
                className={cn(
                  "text-xs py-1 px-3 md:text-sm md:py-2 md:px-4 rounded-lg mb-4 md:mb-6",
                  isPro &&
                    "bg-amber-500/10 text-amber-600 border border-amber-500/20 dark:bg-amber-500/10 dark:text-amber-400"
                )}
              >
                {badgeText}
              </Badge>
