...
export function Header({
  ...
  return (
    <header className="sticky top-3 z-30 w-[90vw] m-auto rounded-full transition-all duration-300 bg-gradient-to-r from-primary/50 to-secondary/30 dark:from-primary/15 dark:to-secondary/15 backdrop-blur-lg pl-2 py-2">
