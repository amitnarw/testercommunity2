  ...
  switch (severity) {
    case "Critical":
      return (
        <Badge
          variant="destructive"
          className="!mt-0 bg-red-700 hover:bg-red-800"
        >
          {severity}
        </Badge>
      );
    case "High":
      return (
        <Badge
          variant="destructive"
          className="!mt-0 bg-red-500/80 hover:bg-red-600"
        >
          {severity}
        </Badge>
      );
    case "Medium":
      return (
        <Badge
          variant="secondary"
          className="!mt-0 bg-amber-500/80 hover:bg-amber-600 text-white"
        >
          {severity}
        </Badge>
      );
    case "Low":
      return (
        <Badge
          variant="secondary"
          className="!mt-0 bg-yellow-500/80 hover:bg-yellow-600 text-white"
        >
          {severity}
        </Badge>
      );
          ...
          <div className="py-4 space-y-6 max-h-[60vh] overflow-y-auto px-6">
            ...
            {type === "Bug" && (
              <div className="space-y-3">
                ...
                <Select
                  onValueChange={(value) =>
                    setSeverity(value as SubmittedFeedbackType["severity"])
                  }
