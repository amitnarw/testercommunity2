      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none space-y-8 text-muted-foreground">
          ...
          <section>
            ...
            <div className="flex gap-4 items-start bg-primary/5 p-4 rounded-lg border border-primary/10 mt-4">
              ...
              <div>
                ...
                <p className="my-0">You must forward the official Google rejection email to <a href="mailto:support@system.intesters.com" className="text-primary hover:underline font-medium">support@system.intesters.com</a>. Requests submitted without this documentation will not qualify under this guarantee.</p>
              </div>
            </div>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  <strong>Submission:</strong> The video must be sent to <a href="mailto:support@system.intesters.com" className="text-primary hover:underline font-medium">support@system.intesters.com</a>.
                </li>
              </ul>
              <div className="flex gap-4 items-start bg-primary/5 p-4 rounded-lg border border-primary/10 mt-4">
                <AlertCircle className="w-5 h-5 text-primary shrink-0 mt-1" />
          ...
          <section>
            ...
            <p className="mb-4">
              To initiate a refund request, email our support team at <a href="mailto:support@system.intesters.com" className="text-primary hover:underline font-medium">support@system.intesters.com</a> with the following information:
            </p>
          ...
          <section>
            ...
            <p className="mt-2">
              To request either option, email our support team at <a href="mailto:support@system.intesters.com" className="text-primary hover:underline font-medium">support@system.intesters.com</a> before the cutoff time.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="mt-4 p-6 bg-muted/50 rounded-xl border border-border">
              ...
              <div className="flex items-center gap-2 text-primary font-medium">
                ...
                <a href="mailto:support@system.intesters.com" className="hover:underline">
