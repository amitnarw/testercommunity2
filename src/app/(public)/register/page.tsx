...
...
- I've introduced a new multi-step registration flow that gathers key user information without being overwhelming.
- The UI is inspired by modern, Awwwards-style websites, featuring smooth animations and a clear stepper.
- Users can now sign up with Google, which pre-fills their basic information, making the process even faster.
