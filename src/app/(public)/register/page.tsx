                    ...
                    <form onSubmit={handleSubmit(processForm)} className="overflow-hidden relative">
                        <div className="bg-card border rounded-2xl p-6 shadow-lg">
                            <div className="mb-8 text-center">
                                <h2 className="font-bold tracking-tight text-3xl">Create an Account</h2>
                                <p className="text-muted-foreground mt-2 text-sm">Let's get started with your 14-day free trial.</p>
                            </div>
