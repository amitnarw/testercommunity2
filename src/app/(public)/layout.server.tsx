...
export const metadata: Metadata = {
  ...
  description: "Get your Android app tested by real users in just 14 days. Earn points for testing apps in our Handshake Testing, or upgrade to Pro for guaranteed, professional results. Built for Google's 12-Tester Requirement.",
