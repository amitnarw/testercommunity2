...
const features = [
  {
    ...
    description:
      "Engage with a vibrant community to get your app tested on a massive range of devices.",
    link: "/community-dashboard",
  },
  {
    title: "Real-Time Dashboards",
    description:
      "Monitor your testing progress with dynamic charts and data visualizations that come to life.",
    link: "/dashboard",
  },
  {
    title: "Gamified Reputation",
    description:
      "Level up your tester profile with animated XP bars and unlockable achievement badges.",
    link: "/community-dashboard",
  },
  {
    title: "Seamless Bug Reporting",
    description:
      "An intuitive and animated bug reporting experience that testers will love.",
    link: "/",
  },
];
      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto px-4 md:px-6 text-center relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              <h1 className="text-[2.25rem] sm:text-[2.75rem] md:text-[3.5rem] lg:text-[4.25rem] font-heading leading-[1.1] tracking-tight font-bold mb-5 sm:mb-6 md:mb-8">
                Testing Your{" "}
                <span className="font-heading font-bold bg-gradient-to-br from-primary to-accent bg-clip-text text-transparent">
                  Android App
                </span>{" "}
                Just Got Easier
              </h1>
              <p className="text-sm sm:text-base md:text-lg font-body max-w-sm sm:max-w-md md:max-w-lg lg:max-w-[700px] mx-auto mb-8 sm:mb-9 md:mb-10 lg:mb-12 text-muted-foreground">
                Get 12+ real testers and meet Google Play’s 14 day rule, fast.
                Use free community testing or go pro with points. Submit, track,
                and launch, all in one place.
              </p>
            ...
            <div className="container mx-auto px-4 md:px-6">
              <div className="text-center">
                <h2 className="text-3xl md:text-4xl font-bold font-heading">
                  A Platform That Works as Good as It Looks
                </h2>
                <p className="mt-4 max-w-2xl mx-auto text-muted-foreground">
                  We've merged cutting-edge functionality with Awwwards-caliber
                  design to create an unparalleled testing experience.
                </p>
              </div>
        ...
        >
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center">
              <h2 className="text-3xl md:text-4xl font-bold font-heading">
                Trusted by a Community of Innovators
              </h2>
              <p className="mt-4 max-w-2xl mx-auto text-muted-foreground">
