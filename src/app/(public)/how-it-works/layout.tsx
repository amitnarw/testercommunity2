...
export const metadata: Metadata = {
  ...
  description: "Learn how inTesters works. Choose between handshake testing (free barter) or professional testing packages to get your Android app tested by real users.",
