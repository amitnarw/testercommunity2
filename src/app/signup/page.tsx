...
import { KloudsBackground } from '@/components/klouds-background';

export default function SignupPage() {
  return (
    <div className="min-h-screen w-full lg:grid lg:grid-cols-2">
      <div className="hidden lg:flex flex-col items-center justify-center p-6 text-center relative overflow-hidden">
        <KloudsBackground />
