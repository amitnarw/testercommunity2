...
export const metadata: Metadata = {
  ...
  description: "Discover and test Android apps with inTesters Handshake Testing. Browse available apps, track your testing requests, and participate in ongoing tests to earn points.",
