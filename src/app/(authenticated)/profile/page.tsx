        ...
        <div className="container mx-auto px-4 md:px-6 pb-12">
            ...
            <div className="max-w-4xl mx-auto space-y-12">
                <Card className="overflow-hidden rounded-2xl shadow-xl shadow-primary/5 border border-dashed">
                 ...
                 <Card className="border-0 shadow-xl shadow-primary/5 p-6 rounded-2xl">
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                        <div className="flex items-center gap-6">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground text-sm mt-1">Invite friends and earn points when they sign up!</p>
                            </div>
                        </div>
                        <Button asChild>
