...
export default function AddAppGuidePage() {
          ...
          <header className="mb-8 max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2">
            <div className="flex flex-col items-start justify-center">
              ...
              <p className="text-muted-foreground mt-2">
                Follow this simple guide to prepare your app. One package will
                be used upon submission.
              </p>
            </div>
          </header>
          ...
          <main className="max-w-4xl mx-auto">
            <div className="space-y-8">
                  ...
                  >
                    <div>
                      ...
                      <p className="text-white/80 text-sm text-center sm:text-start">
                        Watch a short video on how to submit your app.
                      </p>
                    </div>
              ...
              <p className="text-center text-muted-foreground text-sm">
                You can either watch the video above or follow the step-by-step
                guide below. Both cover the same process.
              </p>
                    ...
                    <div className="flex items-start flex-1">
                      ...
                      <div>
                        <h3 className="font-bold text-xl mb-1">
                          Grant Our Testers Access
                        </h3>
                        <p className="text-muted-foreground text-sm text-left">
                          Add our official tester group to your app's internal
                          test track.
                        </p>
                      </div>
                    </div>
                  ...
                  <AccordionContent className="px-6 pb-6">
                    <div className="flex flex-col gap-6 items-start">
                      <div className="flex-1 space-y-4 text-muted-foreground">
                        <p>
                          First, head to the Google Play Console and select your
                          app.
                        </p>
                        ...
                        <p className="text-xs italic">
                          ...
                          14-day test cycle. Your app remains invisible to the
                          public.
                        </p>
                      </div>
                      <div className="w-full flex-shrink-0">
                        <div
                          ...
                          onClick={() =>
                            setFullscreenImage(processSteps[0].imageUrl)
                          }
                        >
                          <SafeImage
                            src={processSteps[0].imageUrl}
                            data-ai-hint={processSteps[0].dataAiHint}
                ...
                >
                  <AccordionTrigger className="p-6 text-left hover:no-underline flex flex-row items-center justify-between w-full relative">
                    <div className="flex items-start flex-1">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm text-left">
                          Make your app available in all countries for maximum
                          test coverage.
                        </p>
                      </div>
                    </div>
                  ...
                  <AccordionContent className="px-6 pb-6">
                    <div className="flex flex-col gap-6 items-start">
                      <div className="flex-1 space-y-4 text-muted-foreground">
                        <p>
                          To ensure our diverse, international team can test
                          your app, you must enable worldwide distribution.
                        </p>
                        <ol className="list-decimal list-inside space-y-3 pl-2">
                          <li>
                          ...
                          <li>
                            Click <Highlight>Add countries / regions</Highlight>
                            .
                          </li>
                          <li>
                            For the best results and maximum coverage, we highly
                            recommend selecting the first checkbox to include{" "}
                            <Highlight>All</Highlight> countries and regions.
                          </li>
                        </ol>
                        <p className="text-xs italic">
                          <strong>Benefit:</strong> This simple step allows
                          testers from different regions with varied network
                          conditions and device models to test your app,
                          uncovering bugs you might otherwise miss.
                        </p>
                      </div>
                      <div className="w-full flex-shrink-0">
                        <div
                          className="relative w-full rounded-lg overflow-hidden group cursor-pointer bg-black/10"
                          onClick={() =>
                            setFullscreenImage(processSteps[1].imageUrl)
                          }
                        >
                          <SafeImage
                            src={processSteps[1].imageUrl}
                            data-ai-hint={processSteps[1].dataAiHint}
                ...
                >
                  <AccordionTrigger className="p-6 text-left hover:no-underline flex flex-row items-center justify-between w-full relative">
                    <div className="flex items-start flex-1">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm text-left">
                          Save your changes and submit them to Google for a
                          quick review.
                        </p>
                      </div>
                    </div>
                  ...
                  <AccordionContent className="px-6 pb-6">
                    <div className="flex flex-col gap-6 items-start">
                      <div className="flex-1 space-y-4 text-muted-foreground">
                        <p>
                          After configuring the tester list and countries, you
                          just need to save the changes.
                        </p>
                        <ol className="list-decimal list-inside space-y-3 pl-2">
                          <li>
                            Click the <Highlight>Save</Highlight> button at the
                            bottom right of the page.
                          </li>
                          <li>
                            This will submit your changes to Google for a
                            standard, automated process to ensure the track is
                            set up correctly.
                          </li>
                        </ol>
                        <p className="text-xs italic">
                          <strong>What to expect:</strong> This is not a full
                          app review. It is a quick check of your testing
                          configuration. Approval is typically very fast, often
                          taking anywhere from a few minutes to a couple of
                          hours.
                        </p>
                      </div>
                      <div className="w-full flex-shrink-0">
                        <div
                          className="relative w-full rounded-lg overflow-hidden group cursor-pointer bg-black/10"
                          onClick={() =>
                            setFullscreenImage(processSteps[2].imageUrl)
                          }
                        >
                          <SafeImage
                            src={processSteps[2].imageUrl}
                            data-ai-hint={processSteps[2].dataAiHint}
                ...
                >
                  <AccordionTrigger className="p-6 text-left hover:no-underline flex flex-row items-center justify-between w-full relative">
                    <div className="flex items-start flex-1">
                      ...
                      <div>
                        <h3 className="font-bold text-xl mb-1">
                          Activate Your Test Cycle
                        </h3>
                        <p className="text-muted-foreground text-sm text-left">
                          Come back to inTesters with your test URL to begin.
                        </p>
                      </div>
                    </div>
                  </AccordionTrigger>
                  <AccordionContent className="px-6 pb-6">
                    <div className="flex flex-col gap-6 items-start">
                      <div className="flex-1 space-y-4 text-muted-foreground">
                        <p>
                          Once Google approves your changes, you're ready to
                          activate the test cycle!
                        </p>
                        <ol className="list-decimal list-inside space-y-3 pl-2">
                          <li>
                          ...
                          <li>
                            Come back to this page, click "Get Started" below,
                            and paste this URL into the{" "}
                            <Highlight>Testing URL</Highlight> field in the
                            form.
                          </li>
                        </ol>
                        <p className="text-xs italic">
                          <strong>Final Step:</strong> After you fill out the
                          form and submit, our testers will be notified
                          automatically, and your 14-day testing cycle will
                          officially begin!
                        </p>
                      </div>
                      <div className="w-full flex-shrink-0">
                        <div
                          className="relative w-full rounded-lg overflow-hidden group cursor-pointer bg-black/10"
                          onClick={() =>
                            setFullscreenImage(processSteps[3].imageUrl)
                          }
                        >
                          <SafeImage
                            src={processSteps[3].imageUrl}
                            data-ai-hint={processSteps[3].dataAiHint}
              ...
              <div className="pt-6 flex justify-end">
                <Button asChild size="lg">
                  <Link href="/dashboard/add-app/form">
