      ...
      <div className="bg-[#f8fafc] dark:bg-[#0f151e] min-h-screen">
        ...
        <div className="container mx-auto px-2 py-5">
          <div className="lg:grid lg:grid-cols-12 lg:gap-16 bg-background rounded-3xl px-3 sm:px-5">
            ...
            <nav className="lg:hidden sticky top-12 z-30 flex items-center justify-around border-b bg-background/80 backdrop-blur-lg">
              {formSteps.map((step) => (
                <a
                  key={`mobile-${step.id}`}
                  href={`#${step.id}`}
                    ...
                    <Card className="bg-secondary/30 border-dashed">
                      <CardContent className="p-3 sm:p-6 grid md:grid-cols-1 gap-8">
                        ...
                        {walletIsPending ? (
                          ...
                          <div
                            className={cn(
                              "p-4 rounded-lg flex flex-col items-center justify-center transition-colors",
                          ...
                          >
                            ...
                            >
                              Your balance:{" "}
                              {(walletData?.totalPoints || 0).toLocaleString()}{" "}
                              points.
                            </p>
                          </div>
                        )}
                        ...
                        <div className="flex flex-row items-center justify-end gap-1 sm:gap-3 w-full">
                          ...
                          >
                            <AnimatedRoundedButton
                              ...
                              borderRadius="9999px"
                              className={cn(
                                isBalanceInsufficient && "!bg-destructive"
                              )}
                            >
