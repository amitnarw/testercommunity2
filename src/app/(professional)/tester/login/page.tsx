...
const ProLoginForm = () => {
    ...
    return (
        <div className="space-y-6">
            <Button variant="outline" className="w-full rounded-xl py-6 text-base" onClick={handleGoogleLogin}>
            ...
            <div className="max-w-md w-full space-y-6">
                <div className="text-center">
                    ...
                    <p className="text-muted-foreground mt-2">
                        Not a pro tester yet? <Link href="/tester/register" className="text-primary hover:underline">Register here</Link>.
                    </p>
                </div>
                <ProLoginForm />
            </div>
