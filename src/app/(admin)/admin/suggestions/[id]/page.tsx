        ...
        <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="flex flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    <div>
                        <h2 className="text-2xl sm:text-3xl font-extrabold bg-gradient-to-br from-primary to-primary/10 bg-clip-text text-transparent">Suggestion Details</h2>
                    </div>
                </div>
                <DropdownMenu>
            ...
            <Card className="rounded-2xl shadow-xl overflow-hidden mt-10">
                <CardHeader className="bg-secondary/30 p-6">
                    <CardTitle className="text-lg sm:text-xl">Suggestion from {item.user}</CardTitle>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3">
                        <div className="lg:col-span-2 p-6 space-y-6">
                            <div className="space-y-3">
                                <h3 className="font-semibold flex items-center gap-2 text-muted-foreground"><Lightbulb className="w-5 h-5" /> Content</h3>
                        ...
                        <div className="lg:col-span-1 bg-secondary/50 p-6 space-y-6 border-l">
                            ...
                            <div className="space-y-2">
                                ...
                                <Badge
                                    ...
                                    className={status === 'Shipped' ? 'bg-green-500/20 text-green-700 dark:bg-green-500/10 dark:text-green-400' : ''}
                                >
                                    {status}
                                </Badge>
                            </div>
