...
import { Search, Users2, ArrowLeft, ExternalLink, Clock, CheckCircle, XCircle, Loader2 } from "lucide-react";
...
function AdminSubmissionFreeDetailContent() {
    ...
    <div className="flex-1 space-y-6 container mx-auto px-4 md:px-6 py-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-2">
        <div className="flex items-center gap-4">
          <TransitionLink href="/admin/submissions-free">
          ...
          <div>
            ...
            <p className="text-sm sm:text-md text-muted-foreground">
              View and manage this community submission.
            </p>
          </div>
        </div>
      </div>
...
export default function AdminSubmissionFreeDetailPage() {
  return (
    <Suspense fallback={<div className="p-8 text-center">Loading...</div>}>
      <AdminSubmissionFreeDetailContent />
    </Suspense>
  );
}