...
import { ArrowLeft, Check, Download, Mail, Phone, Shield, User, X } from "lucide-react";
...
const applications = [
    ...
    { id: 2, name: "David Kim", email: "david@example.com", date: "2024-08-19", experience: "5+ years", expertise: ["Automation", "Performance", "API"], bio: "Senior QA Automation Engineer with extensive experience in creating and maintaining test frameworks using Selenium, Appium, and Postman. Proven ability to improve testing efficiency and coverage. Looking to apply my skills to challenging mobile projects.", avatar: "https://i.pravatar.cc/150?u=david-kim", phone: "555-0102" },
    { id: 3, name: "Alex Johnson", email: "alex@example.com", date: "2024-08-18", experience: "1-3 years", expertise: ["Manual"], bio: "Enthusiastic and fast-learning junior tester with a solid foundation in manual testing methodologies. Eager to contribute to a dynamic team and grow my skills in the mobile testing space. I have a keen eye for detail and a knack for breaking things.", avatar: "https://i.pravatar.cc/150?u=alex-johnson", phone: "555-0103" },
    { id: 4, name: "Priya Patel", email: "priya@example.com", date: "2024-08-17", experience: "3-5 years", expertise: ["Security", "Manual"], bio: "Cybersecurity professional with a focus on mobile application security testing. Experienced in vulnerability assessment, penetration testing, and static/dynamic analysis. Certified Ethical Hacker (CEH).", avatar: "https://i.pravatar.cc/150?u=priya-patel", phone: "555-0104" },
    { id: 5, name: "Michael Chen", email: "michael@example.com", date: "2024-08-16", experience: "5+ years", expertise: ["Automation", "API", "Performance"], bio: "Results-driven QA lead with a track record of implementing successful performance and API testing strategies. Proficient with JMeter, Gatling, and REST Assured. Strong leadership and mentoring skills.", avatar: "https://i.pravatar.cc/150?u=michael-chen", phone: "555-0105" },
];
                ...
                <div className="lg:col-span-1 space-y-8">
                     <Card>
                        <CardContent className="pt-6 flex flex-col items-center text-center">
                            ...
                            <Badge variant="secondary" className="mt-4">New Applicant</Badge>
                        </CardContent>
                    </Card>
