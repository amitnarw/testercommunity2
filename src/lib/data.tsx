...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt:
      "Learn the fundamentals of automated testing and how it can save you time and improve your product quality.",
  ...
  },
  {
    ...
    excerpt:
      "Discover how user experience (UX) testing can transform your app from functional to delightful.",
  ...
  },
  {
    ...
    excerpt:
      "A comprehensive checklist for mobile app security testing to protect your users and your reputation.",
    ...
    author: {
      name: "George Hill",
      avatarUrl:
        "https://images.unsplash.com/photo-1527982987257-d3abc440f2ba?q=80&w=400&auto=format=fit=crop",
  ...
  },
  {
    ...
    excerpt:
      "Ensure your application is usable by everyone. A guide to WCAG standards and practical accessibility testing tips.",
  ...
  },
  {
    ...
    excerpt:
      "A slow app is a failed app. Learn how to load test your application and identify bottlenecks before your users do.",
    ...
    author: {
      ...
      dataAiHint: "woman developer glasses",
    },
    date: "2024-06-18",
    imageUrl:
...
export const communityApps: CommunityApp[] = [
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/c6EgFHn_tZjMLPFUYA7ugHYpHHeUA_Km0u8iIDPIapV9HvmtzSPki6CNPz9tqZJQwSg=w5120-h2880-rw",
        alt: "Todoist Screenshot 1",
        dataAiHint: "task list interface",
      },
      {
        url: "https://play-lh.googleusercontent.com/5GVvBM-QT83cTK7JXF_jthPrQkyKB6QkDppBJ2_uuT13KijJa11vkbfvbxL0tHtJ5A=w5120-h2880-rw",
        alt: "Todoist Screenshot 2",
        dataAiHint: "project board",
      },
    ],
    testingInstructions:
      "Please focus on the new team collaboration feature. Try creating a project, inviting a team member, and assigning a task. Check for notification accuracy and any sync issues.",
    status: "ongoing",
    progress: 60,
    totalDays: 14,
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/7cbF0CaotSfUmbK7UMt9NJdKP445eLN58Tf84P7qkyiS92gwnZg8A58Nkc45ZkAVOQ=w5120-h2880-rw",
        alt: "Brawl Stars Screenshot 1",
        dataAiHint: "gameplay screenshot",
      },
      {
        url: "https://play-lh.googleusercontent.com/fI4YdE1laVv-hKex_etmpvr5_gSTIv9uGMua_KsFWb7lIxdGTdN82wESwewYzTt1bA=w5120-h2880-rw",
        alt: "Brawl Stars Screenshot 2",
        dataAiHint: "game characters",
      },
    ],
    testingInstructions:
      'Play the new "Gem Grab" mode. We are looking for feedback on matchmaking balance, performance during intense fights, and the new Brawler\'s abilities.',
    status: "completed",
  ...
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/OVNqxXWPyZUilt-abUeBHuML5_nrqJvFP7MTvhWS0JqIAyjUUgte7c0NKBdGakdF97JjPiGz0DgWNr05YMFkkOg=w5120-h2880-rw",
        alt: "AccuWeather Screenshot 1",
        dataAiHint: "weather map",
      },
      {
        url: "https://play-lh.googleusercontent.com/iVDM63eIo8Gs74i1tD3I_oOubcxQZmapkrSQGj3UI0ECO-PoHDK7Rdicf4Ak2CK-S7Ua3EItYmnOGEZcJpi4RA=w5120-h2880-rw",
        alt: "AccuWeather Screenshot 2",
        dataAiHint: "hourly forecast",
      },
    ],
    testingInstructions:
      'Check the "Minutecast" feature for your current location. Please verify if the precipitation forecast is accurate and report any UI issues with the radar map.',
    status: "request_rejected",
    rejectionReason:
      "Your account does not meet the minimum tester level required for this app.",
    totalDays: 20,
  },
  {
    id: 4,
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/VuG8-L7VopdChWJSvh5HC_o4KZpoP_qVU_4NjsJ1KUWO1cmK2hchaZnyWEtmN38CeQ=w5120-h2880-rw",
        alt: "Reddit Screenshot 1",
        dataAiHint: "social feed",
      },
      {
        url: "https://play-lh.googleusercontent.com/x7SelyleRNR8Un3SAKzpu9eKeX6tTEhZsM5EW5vxcHQG2KnM0_wmZkfa92SLwPraKFla=w5120-h2880-rw",
        alt: "Reddit Screenshot 2",
        dataAiHint: "community page",
      },
    ],
    testingInstructions:
      "Test the new video player controls. Try watching several videos, scrubbing, and changing the playback speed. Report any crashes or performance issues.",
    status: "available",
    totalDays: 14,
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/MYxB6AedO95sOoYM5B3q7_DDbYAzonV_15V8tuabDEyhM9NQTmoL0y-oDA7NCnp6oMU=w1052-h592-rw",
        alt: "Subway Surfers Screenshot 1",
        dataAiHint: "game character running",
      },
      {
        url: "https://play-lh.googleusercontent.com/sQPwy6UqraoYT-gL3Gvx6R0HXfEGOvKWs8buCzRLJYIyHlp9skdVwnnOcG3dwo33ChF6=w1052-h592-rw",
        alt: "Subway Surfers Screenshot 2",
        dataAiHint: "gameplay obstacles",
      },
    ],
    testingInstructions:
      'Play the game until you can afford the new "Super Sneaker" power-up. We are looking for feedback on its price balance and overall usefulness.',
    status: "available",
    totalDays: 15,
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/IDtkl9rmDFCaMHVpIHEUy6YvaQ7dZbc19v7zXU2637hJOqPzFo6-WS6TUaIe45L8dZrXURDBQMZGpOnZL8hNtA=w1052-h592-rw",
        alt: "Notion Screenshot 1",
        dataAiHint: "project document",
      },
      {
        url: "https://play-lh.googleusercontent.com/oRlLXgugaEQwBZky-psvZuaPpJr-56kS6AhZULtHi2n_96qHj27EpE3OZqJtzBG2WoWxvb13OlN33DsWjHG5qQ=w1052-h592-rw",
        alt: "Notion Screenshot 2",
        dataAiHint: "database table view",
      },
    ],
    testingInstructions:
      "Create a new database, add at least 5 entries with different properties (text, date, select). Test the filtering and sorting functionality.",
    status: "available",
    totalDays: 14,
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/bpbZj-0dChEpZ2X1pT83gZJi0CFHdVlK3Ja_nC1bDGzpX5aPTyCQDQ-s4gn6fBXmsQ=w1052-h592-rw",
        alt: "Duolingo Screenshot 1",
        dataAiHint: "language lesson",
      },
      {
        url: "https://play-lh.googleusercontent.com/ERs3Y-33zoFG7aIaRYdg67QwHb6YOJB0lZdM9U8x3YMvT8m1XTXf5WRS-CzymdEoJw=w1052-h592-rw",
        alt: "Duolingo Screenshot 2",
        dataAiHint: "learning path",
      },
    ],
    testingInstructions:
      "Complete one full lesson in any language. Verify that the progress is saved correctly and check for any issues with audio playback during exercises.",
    status: "requested",
    totalDays: 18,
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/fOaUJKnuMPk02Gl5qu_B6ePw0myxaNJx3QZihKxsaAix5TYKl1NnfmvzZ52nSAc3w8nD=w1052-h592-rw",
        alt: "Spotify Screenshot 1",
        dataAiHint: "now playing screen",
      },
      {
        url: "https://play-lh.googleusercontent.com/a7950Z_tJAMl7t9mh62ZBJianaWewvFqSXbpp4XqnrShHD1x4_JzB4ONSfM124rAvd3J=w1052-h592-rw",
        alt: "Spotify Screenshot 2",
        dataAiHint: "music playlist",
      },
    ],
    testingInstructions:
      'Test the "Blend" feature with a friend. Create a new Blend playlist and check if it updates correctly after both of you listen to more music.',
    status: "available",
    totalDays: 14,
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/Uev9_yBzAAhQJAxF2OH2chJM5ZtldwS2QLZuRna6Sxa-E8_V2DNTvhM1ErtO9Y-EovEW=w1052-h592-rw",
        alt: "Netflix Screenshot 1",
        dataAiHint: "movie selection screen",
      },
      {
        url: "https://play-lh.googleusercontent.com/kgPN0hxOygJ0BvBKO_MppY5ffCxgjVby_4I8qZVOG3ZP1LkZsk6yR6kiACfo1G_jX3FA=w1052-h592-rw",
        alt: "Netflix Screenshot 2",
        dataAiHint: "tv show profile page",
      },
    ],
    testingInstructions:
      "Test the download feature for offline viewing. Download a show, put your phone in airplane mode, and try to play it. Report any issues.",
    status: "ongoing",
    progress: 30,
    totalDays: 20,
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/TuldCmJnsld3yG9AG_vvVsWtJQhd0KGOekfZgZpjqGiT-CVQ3J5uuUyMEdF7e6X86W29=w1052-h592-rw",
        alt: "Minecraft Screenshot 1",
        dataAiHint: "game world",
      },
      {
        url: "https://play-lh.googleusercontent.com/Oy0VBqSTujyHQdqbSPD4GvuKYb01OdY_36OAZV1JozE5J62e-Ok12BSwPCw4w72nU6c=w1052-h592-rw",
        alt: "Minecraft Screenshot 2",
        dataAiHint: "underwater gameplay",
      },
    ],
    testingInstructions:
      "Join a multiplayer server and play for at least 15 minutes. We are looking for any connection issues, lag, or graphical glitches during multiplayer sessions.",
    status: "available",
    totalDays: 25,
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/xVRB5spVTzA2TX9R9E2XxcFmLncAQGUvR6N25-2D0f2LtZfOsOvUEMeJd8m3I9_Ytw=w1052-h592-rw",
        alt: "TikTok Screenshot 1",
        dataAiHint: "video feed interface",
      },
      {
        url: "https://play-lh.googleusercontent.com/MzHRecSy-VSHfikBu1nWferUxTc9EJKE4BJODAffLQPiEpkjVKMvun02jn-KMKtIMQ=w1052-h592-rw",
        alt: "TikTok Screenshot 2",
        dataAiHint: "video creation tools",
      },
    ],
    testingInstructions:
      'Test the new "Stitch" feature with a video from your "For You" page. Ensure the editing tools work as expected and the final video posts correctly.',
    status: "available",
    totalDays: 14,
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/Bt95BAHb_F8Wdn_Xt1z7sBjUXAD-UIYX_mqAhhRFIv5PobR3vpteXfzNC0ZYiVJPSgM=w1052-h592-rw",
        alt: "Amazon Screenshot 1",
        dataAiHint: "product page",
      },
      {
        url: "https://play-lh.googleusercontent.com/q-3YfdVSQGgEJ9gj8KCnS17bu4fJmDZxkNzTeaR7bQg2p0lwHFSmBlYCUlW84g32A6w=w1052-h592-rw",
        alt: "Amazon Screenshot 2",
        dataAiHint: "home page deals",
      },
    ],
    testingInstructions:
      "Add three different items to your cart and proceed to the checkout page. Do not complete the purchase. Report any issues with the UI or calculation errors in the subtotal.",
    status: "completed",
  ...
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/z_Fhk7tBiw-Uj0kdr3xC0PcpGrf8QNo3theULld7m_S5TiPGs82vU_gLYkiPyOjkew=w1052-h592-rw",
        alt: "OneDrive Screenshot 1",
        dataAiHint: "file browser",
      },
      {
        url: "https://play-lh.googleusercontent.com/6kpAhVXfEBoGHf3AF27S2lm99kUoA8p0X4Gjvphw4evsPE4aGO8iddyQjT0OwUQDE7xG=w1052-h592-rw",
        alt: "OneDrive Screenshot 2",
        dataAiHint: "photo view",
      },
    ],
    testingInstructions:
      "Upload a photo to your OneDrive. Then, try to share the link to that photo with another app (e.g., messaging app). Report any issues with the sharing process.",
    status: "ongoing",
    progress: 50,
    totalDays: 14,
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/NedHTUnKlJffJLyfv86IyDqyCwTfUSvr_5KldNbeWaZgtNe-aWlqwglcGcvRn_awTPA=w1052-h592-rw",
        alt: "Clash of Clans Screenshot 1",
        dataAiHint: "village base",
      },
      {
        url: "https://play-lh.googleusercontent.com/jifDVIpK_477kQvBYnXknD4DtGAyzYhIM7zamo-QQdFDaT7uqQoCtljM5Bf_2DcixRlN=w1052-h592-rw",
        alt: "Clash of Clans Screenshot 2",
        dataAiHint: "battle scene",
      },
    ],
    testingInstructions:
      "Participate in a Clan War. Attack an enemy base and check if the replay functionality works correctly. Report any visual glitches during the battle.",
    status: "available",
    totalDays: 14,
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/txZg8DG_fuYDdhiH0haLYd6zHpokFpzXP9gb_3ljVHI8VeVzCkMy-YFZ9-fxXM_cHuwl=w1052-h592-rw",
        alt: "Google Photos Screenshot 1",
        dataAiHint: "photo gallery",
      },
      {
        url: "https://play-lh.googleusercontent.com/-dmhCalMOHT7z0RyDFaMuSUy3C6dSoWQfJuyvgJiu0m6hCKhoP-iSm7o7Hrfcyucm2E=w1052-h592-rw",
        alt: "Google Photos Screenshot 2",
        dataAiHint: "photo editing",
      },
    ],
    testingInstructions:
      'Use the "Memories" feature. View a few memories and try to customize one by adding or removing photos. Ensure the changes are saved correctly.',
    status: "ongoing",
    progress: 80,
    totalDays: 14,
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/JWzREHRyz1VttPQfiKXlMRYOAvz78h6SY_1RUoDjJvW4ClVYoHEZA3tkJ_1RaFe2JA=w1052-h592-rw",
        alt: "Uber Screenshot 1",
        dataAiHint: "map with car",
      },
      {
        url: "https://play-lh.googleusercontent.com/cZUMicgTrQQkFashDnSRHl0yFl75_EAIJmCT6Sq6SeVbdh96ASMJBRAqZ0DLWBILWJ4=w1052-h592-rw",
        alt: "Uber Screenshot 2",
        dataAiHint: "ride options",
      },
    ],
    testingInstructions:
      "Set a destination and view the different ride options (UberX, Comfort, etc.). Do not book a ride. Report any issues with the map display or price estimation.",
    status: "available",
    totalDays: 14,
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/ERlslwKS3qgVxLm9KBkIPBg7JFexcing9c0oljWBZpdZb6gY_O5B08r_YqERKqdVUw=w1052-h592-rw",
        alt: "LinkedIn Screenshot 1",
        dataAiHint: "professional profile",
      },
      {
        url: "https://play-lh.googleusercontent.com/fzAm6QzzZ0BPmtLdgaL6Au1aQWoYvGPQ-KPP621JRcKcL5nNujyYDUhhww4KyxpTDA=w1052-h592-rw",
        alt: "LinkedIn Screenshot 2",
        dataAiHint: "professional network feed",
      },
    ],
    testingInstructions:
      "Update a section of your profile (e.g., add a new skill). Check that the changes are reflected correctly across the app. Then, view a job posting and save it.",
    status: "completed",
  ...
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/cDeHHV-DBIdqrd7o--FYHbDjd845Uupm_lbCrSc-O7wSaHSjnsMo9CCzDHEQI3i9TnP-=w1052-h592-rw",
        alt: "Zoom Screenshot 1",
        dataAiHint: "video conference call",
      },
      {
        url: "https://play-lh.googleusercontent.com/wf50ibsSuh3Y74yhgSjp_sF5hQuaQC4qaad7Z5_xPG0BPwR6D8wWlwDgHVTo0-ikfw=w1052-h592-rw",
        alt: "Zoom Screenshot 2",
        dataAiHint: "meeting schedule",
      },
    ],
    testingInstructions:
      "Start a new meeting with only yourself. Test the virtual background feature. Ensure that the background applies correctly and there is no significant performance drop.",
    status: "available",
    totalDays: 14,
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/zMi_TI6DqxBnylsqmO10TaKknp-su3HdHu5lpYQlxAUfTE13tAswW8KnB4UiUFCrH2s=w1052-h592-rw",
        alt: "Discord Screenshot 1",
        dataAiHint: "chat server interface",
      },
      {
        url: "https://play-lh.googleusercontent.com/LUbhjBDsItfhj8FnM3mDhekkaUCecqF6s49T2AyhgRyZsFijrw7lcKd74gM2E9ctGQ=w1052-h592-rw",
        alt: "Discord Screenshot 2",
        dataAiHint: "voice channel",
      },
    ],
    testingInstructions:
      "Join a voice channel in a server. Test the noise suppression feature by enabling it and speaking with background noise. Report on its effectiveness.",
    status: "requested",
    totalDays: 14,
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/utDtGKlNK8rh0D0NN0exEvS-utQ2r_1se_sjVPYH31oIBcQo0bkooPFH1Dd9IMhGJ3UpFMJtPcVf-9wHoePQ3g=w1052-h592-rw",
        alt: "Pinterest Screenshot 1",
        dataAiHint: "image grid feed",
      },
      {
        url: "https://play-lh.googleusercontent.com/b7wC5dtsv1qdp-ys_GwoNNsvu2-CCFuntridk6sr13Wg_bX3r7UPKgOpWF9CXPzf36cdG1E06ID9EpKmxFSvyA=w1052-h592-rw",
        alt: "Pinterest Screenshot 2",
        dataAiHint: "pin detail view",
      },
    ],
    testingInstructions:
      'Create a new board and save at least 5 pins to it. Test the "More ideas" section on the board to see if the suggestions are relevant.',
    status: "available",
    totalDays: 14,
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/Os5RuUgRRPskSEWwMOCgySW7wxUIBYuTYEP5DRxQi7naVkqdZmTrpB1z3ERPN_1RqO_j=w1052-h592-rw",
        alt: "Airbnb Screenshot 1",
        dataAiHint: "home rental listing",
      },
      {
        url: "https://play-lh.googleusercontent.com/2QLnpUwoUtj9I3iTT0yd2nMJezAQD4YCk6FyCzsgrZTP74SgfxmE_Uyqs4fU7d4SlII=w1052-h592-rw",
        alt: "Airbnb Screenshot 2",
        dataAiHint: "map view with prices",
      },
    ],
    testingInstructions:
      "Search for a stay in any city for a future date. Apply at least 3 filters (e.g., Wi-Fi, Kitchen, Price Range) and check if the results update correctly.",
    status: "request_rejected",
    rejectionReason:
      "The developer has paused new tester requests for this app.",
    totalDays: 14,
  },
  {
    id: 22,
  ...
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/EbBpHZ0sYqgZ2c6lbtldTrpnL2kL2fbI9aZjxodLi3p9shnIyRsoPOfK9ueieK4P6s4=w1052-h592-rw",
        alt: "Audible Screenshot 1",
        dataAiHint: "audiobook player",
      },
      {
        url: "https://play-lh.googleusercontent.com/MdfmlSGUqETv3zLRTDflkFY5IG-70dGBUFNYarO4wEl9mqbAczJyr16pO3CZF0V5Mw8=w1052-h592-rw",
        alt: "Audible Screenshot 2",
        dataAiHint: "library view",
      },
    ],
    testingInstructions:
      "Listen to a sample of any audiobook. Test the sleep timer feature by setting it for 5 minutes. Verify that the playback stops after the set time.",
    status: "available",
    totalDays: 14,
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/s06uBXcm9aDF3xQsgFGuaMgtqEbeJi1WBw0P1mFYKPoBCiVTCv7DoW5RYXLEYNK_mRPp=w1052-h592-rw",
        alt: "Google Maps Screenshot 1",
        dataAiHint: "navigation view",
      },
      {
        url: "https://play-lh.googleusercontent.com/UnOWNTXSmmaaQP2bFAnOZo0G77yUcauw_ce5RxoOIEAqjlLHmaIO8v8gxlEemuU14_U=w1052-h592-rw",
        alt: "Google Maps Screenshot 2",
        dataAiHint: "explore places",
      },
    ],
    testingInstructions:
      "Find directions to a location using public transit. Check if the app provides multiple route options and accurate departure times. Report any discrepancies.",
    status: "completed",
  ...
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/sSTOCmOjUM98O7Cx9ScaaNevgl3MT8vGqQ8J793xckZORDKGC3DYLVEQCNAwErWcSNg=w1052-h592-rw",
        alt: "Twitch Screenshot 1",
        dataAiHint: "live stream view",
      },
      {
        url: "https://play-lh.googleusercontent.com/Pe2oAtIT8__GC7t_DSBHDySeRTsXtWDeasIJRYHRkppgTFlZZqwk7y-thE0GYctRCTk=w1052-h592-rw",
        alt: "Twitch Screenshot 2",
        dataAiHint: "channel page",
      },
    ],
    testingInstructions:
      "Watch a live stream and try using Channel Points to redeem a reward. Verify that the reward activates correctly and your points balance is updated.",
    status: "available",
    totalDays: 14,
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/RmO2rsRpDZn_t4gvHS0AovZvm0Bf6wwsIDvPjGoKGhCbKBRvZuFOdqNiegftaopKuJUo=w1052-h592-rw",
        alt: "Shazam Screenshot 1",
        dataAiHint: "song identification screen",
      },
      {
        url: "https://play-lh.googleusercontent.com/r2aQs5r_jnqEc1DQCRnfPjEhpH_Adqw60we7kReYylUssw23xN9c95MdxkiNcFYbOA=w1052-h592-rw",
        alt: "Shazam Screenshot 2",
        dataAiHint: "song details page",
      },
    ],
    testingInstructions:
      "Identify a song by playing music from another device. After identification, check if the lyrics are available and sync correctly with the song.",
    status: "available",
    totalDays: 14,
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/wlwY1vowGxTrvQMRDHJD21iYBG7S_E09QbKPY-L6dqEc4UxCi0fDQiNuCBonFYED1yU=w1052-h592-rw",
        alt: "Telegram Screenshot 1",
        dataAiHint: "chat interface",
      },
      {
        url: "https://play-lh.googleusercontent.com/NaeXtT-aGP9_R8LROs3XyWVc6eU7sxYuuywNwg3c99AjRtj6cCoPaJynhP0t8uynF6hm=w1052-h592-rw",
        alt: "Telegram Screenshot 2",
        dataAiHint: "channel view",
      },
    ],
    testingInstructions:
      "Create a new sticker pack by uploading an image. Ensure the sticker is created successfully and can be sent in a chat.",
    status: "ongoing",
    progress: 20,
    totalDays: 14,
  },
  {
    ...
    screenshots: [
      {
        url: "https://play-lh.googleusercontent.com/xRXui7PTkU-MrsnbuCPc0Y1ThX5uDUA-i0J5HGIxTM53aVL7ea_QdyO4jz8qXhNZODpu=w1052-h592-rw",
        alt: "Signal Screenshot 1",
        dataAiHint: "encrypted chat",
      },
      {
        url: "https://play-lh.googleusercontent.com/oWgzBb5N9ktqX0VQRHwoZsLRDt4CTvhv-lCE30PUemIKm12kdFpYVa5z4Zs2XDkMFI8=w1052-h592-rw",
        alt: "Signal Screenshot 2",
        dataAiHint: "group call",
      },
    ],
    testingInstructions:
      "Send a disappearing message with a custom timer. Verify that the message disappears for both you and the recipient after the timer expires.",
    status: "available",
    totalDays: 14,
  },
];
...
export const transactionHistory = [
  ...
  },
  {
    ...
    date: "2024-08-18",
    type: "Package Used",
    description: 'Submitted "Project Phoenix"',
    amount: "-1 Package",
    change: "-1 Package",
    status: "Completed",
    changeType: "negative",
...
const generateFeedback = (projectName: string) => {
  ...
  const severities: ("Critical" | "High" | "Medium" | "Low" | "N/A")[] = [
    "Critical",
    "Low",
    "N/A",
    "High",
  ...
  return Array.from({ length: 15 }, (_, i) => {
    ...
    return {
      ...
      comment:
        comments[type as keyof typeof comments] ||
        `Generic feedback item #${i + 1}`,
      date: `2024-08-${20 - (i % 10)}`,
      screenshot: hasScreenshot
        ? `https://picsum.photos/seed/${projectName.length + i}/400/800`
        : null,
      videoUrl: hasVideo
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    reviewNotes:
      "Initial review in progress. Checking for policy compliance and testability.",
  ...
  },
  {
    ...
    testingInstructions:
      "Please check the notification settings. Configure custom notifications for a specific channel and verify that you receive them as expected.",
    androidVersion: "9+",
    pointsCost: 2000,
    crashFreeRate: 100,
    overallRating: 4.5,
  ...
  },
  {
    ...
    description:
      "Asana is the easiest way to manage team projects and your individual tasks. From the small stuff to the big picture, Asana organizes work so you and your teams are clear on what to do, why it matters, and how to get it done.",
    testingInstructions:
      "We are launching a new 'Goals' feature. Please try creating a new goal, linking it to a project, and updating its status. We're interested in feedback on the UI and ease of use.",
    androidVersion: "12+",
    pointsCost: 1500,
    reviewNotes:
      "Initial review in progress. Checking for policy compliance and testability.",
  ...
  },
  {
    ...
    startedFrom: "N/A",
    description:
      "With this app, you can easily generate pure tones that help stimulate focus, meditation, or deep relaxation.",
    testingInstructions: "",
    androidVersion: "",
    pointsCost: 0,
  ...
  },
  {
    ...
    description:
      "Google Wallet gives you fast, secure access to your everyday essentials. Tap to pay everywhere Google Pay is accepted, board a flight, go to a movie, and more - all with just your phone.",
    testingInstructions:
      "Test adding a new loyalty card by searching for a merchant. Also, try reordering the cards in your wallet.",
    androidVersion: "9+",
    pointsCost: 1500,
    crashFreeRate: 99.95,
    overallRating: 3.9,
  ...
  },
  {
    ...
    testingInstructions:
      "Focus on the automation feature (Butler). Create a rule that moves a card to a different list when a label is added. Verify it works as expected.",
    androidVersion: "10+",
    pointsCost: 2500,
    crashFreeRate: 98.5,
    overallRating: 3.5,
    ...
    rejectionReason: {
      ...
      description:
        "Our review found that the app is currently restricted to North America. To ensure our global community of testers can access your app, please make it available in all countries/regions within your Google Play Console settings. This allows for diverse testing across different devices and network conditions.",
      imageUrl:
        "https://images.unsplash.com/photo-1601034913836-a1f43e143611?q=50&w=500&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  ...
  ...[
    ...
    const baseApp =
      communityApps.find((app) => app.name === override.name) ||
      communityApps[index % communityApps.length];
    ...
    const testersStarted =
      testersCompleted +
      (isOngoing ? 5 : 0) +
      (override.status === "In Review" ? 2 : 0);
    return {
      id: override.id,
      name: baseApp.name,
      packageName: `com.example.${baseApp.name
        .toLowerCase()
        .replace(/[^a-z0-9]/g, "")}`,
      icon: baseApp.icon,
      dataAiHint: baseApp.dataAiHint,
      category: baseApp.category,
      status: override.status as
        | "In Testing"
        | "Completed"
        | "In Review"
        | "Draft"
      ...
      feedbackBreakdown: {
        total: testersCompleted * 3,
        critical: Math.floor(testersCompleted / 5),
        high: Math.floor(testersCompleted / 3),
        low: testersCompleted * 2,
      },
      performanceMetrics: {
        avgStartupTime: `${300 + (override.id % 10) * 10}ms`,
        frozenFrames: `0.${override.id % 10}%`,
      },
      deviceCoverage: [
        ...
        { device: "Samsung Galaxy", testers: Math.floor(testersStarted / 3) },
        {
          ...
          testers:
            testersStarted -
            Math.floor(testersStarted / 2) -
            Math.floor(testersStarted / 3),
        },
      ],
      osCoverage: [
      ...
      reviewNotes:
        override.status === "In Review"
          ? "Pending tester availability."
          : undefined,
